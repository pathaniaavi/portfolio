...
function SpringBootIcon({ width, height, color }) {
  return (
    <svg width={width} height={height} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none">
...
SpringBootIcon.defaultProps = {
  width: '24px',
  height: '24px',
  color: '#000000',
};

SpringBootIcon.propTypes = {
