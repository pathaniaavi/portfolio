...
import { Bars3Icon, BellIcon, XMarkIcon } from '@heroicons/react/24/outline'// assuming you have defined these icons somewhere
...
function NavigationBar({ navigation, user, userNavigation }) {
  return (<Disclosure as="nav" className="bg-black">
              {({ open }) => (
                <>
